...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "Youzix！",
	siteURL: "https://youzix.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-03", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Youzix-Star/Mizuki",
					external: true,
				...
				{
					name: "Gitee",
					url: "https://gitee.com/Youzix_Star",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://youzix.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
